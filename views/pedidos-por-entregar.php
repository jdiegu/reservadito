...
<head>
  ...
  <title>Pedidos Entregar - Reservadito</title>
...
<body>
    ...
    <section class="menu-list">
      ...
      if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
          ...
          echo '<button class="btn-completar" value="' . $row["pedido"] . '" > Entregar pedido </button>';
  ...
  <div id="confirmModal" class="modal">
    <div class="modal-content">
      <p id="modalMessage">¿Estás seguro que quieres entregar este pedido?</p>
      <p id="platilloPedido2"></p>
      <p id="cliendePedidor2"></p>
      <div class="modal-buttons">
        <form action="../models/pedido/entregar-pedido.php" method="POST">
    ...
    <div class="modal-content">
      ...
      <div class="modal-buttons">
        <form action="../models/pedido/cancelar-pedido.php" method="POST">
          ...
          <input type="hidden" name="me" value="pedidos-por-entregar.php">
