...
if ($stmt->execute()) {
    ...
    if ($row = $result->fetch_assoc()) {
        ...
        $update_sql = "UPDATE usuarios SET notificacion = 1 WHERE id_usuario = ?";
   ...
   <body data-popup-msg="Pedido completado exitosamente" data-popup-img="../../assets/media/check.png" data-popup-redi="../../views/pedidos-pendientes.php">
   ...
   <body data-popup-msg="Error al completar el pedido" data-popup-img="../../assets/media/error.png" data-popup-redi="../../views/pedidos-pendientes.php">
   <script src="../../assets/js/popup_script.js"></script>
   </body>
   </html>';
}
